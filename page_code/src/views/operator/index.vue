  ...
  <div class="buaa-operator">
    <div class="operator-intro clearfix">
      <div class="intro-left">
        <div class="intro-title">共性框架</div>
        <div class="intro-subtitle">异构混合的基础框架与计算库，通过算子适配、计算图构建、计算库加速等技术，为共性平台提供基础能力支持。</div>
        <div class="intro-content clearfix">
          <span :class="collapse ? 'content-span' : ''">通过算子适配、计算图构建、计算库加速等技术，为共性平台提供基础能力支持。科学智算算子异构混合适配技术，聚焦实现复杂算子在异构芯片混合架构的可扩展适配，突破基础算子扩展、高阶自动微分算子拆分、复杂算子适配等难题；高阶计算图自动构建技术，实现复杂科学智算流程的灵活表示和高效执行；研究多领域计算库的设计与任务加速，设计模块化的科学计算库，突破智能方程求解和仿真模拟任务的加速计算。异构混合的基础框架与计算库是一套支持模块化、可扩展、全流程的模型算子开发基础框架和服务于科学智算任务的多领域基础计算库，为人工智能科学计</span>
...
export default {
  ...
  data() {
    return {
      ...
      comList: [
        {title: '高阶微分类', id: 2, desc: '描述描述描述描述描述描述描述描述'},
        {title: '复数操作类', id: 1, desc: '描述描述描述描述描述描述描述描述'},
        {title: '傅里叶变换类', id: 4, desc: '描述描述描述描述描述描述描述描述'},
        {title: '线性代数类',id: 8,  desc: '描述描述描述描述描述描述描述描述'},
        {title: '分数阶微分类', id: 13, desc: '描述描述描述描述描述描述描述描述'},
        {title: '积分操作类', id: 5, desc: '描述描述描述描述描述描述描述描述'},
      ]
    }
  },
  methods: {
